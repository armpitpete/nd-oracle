...
class QuestionDiscoveryV07Tests(unittest.TestCase):
    ...
    def test_home_keeps_practical_discovery_before_topic_orientation(self):
        ...
        for question_id in build_site.FEATURED_QUESTION_IDS:
        ...
        self.assertIn(f"Browse all {len(self.questions)} practical questions", page)
        self.assertLess(
    ...
    def test_sitemap_includes_question_index_and_every_question(self):
        ...
        self.assertGreater(len(paths), 42)

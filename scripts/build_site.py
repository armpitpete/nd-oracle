...
_compat06__STYLE_REV = hashlib.sha256((_compat06__SITE_DIR / 'styles.css').read_bytes()).hexdigest()[:12]
...
{robots}{canonical}  <title>{_compat06__esc(title)} · The Neurodiverse Oracle</title>
  <link rel="stylesheet" href="/styles.css?v={_compat06__STYLE_REV}">
</head>
...
V10_ROUTE_COUNT = 450
QUESTION_GROUPS = [('Daily life & technology', ['task-starting-and-organisation', 'make-device-easier-to-use', 'meal-planning-and-everyday-food-tasks', 'household-tasks-chore-overload', 'appointments-admin-preparation', 'transitions-change-between-tasks']), ('Sensory & environment', ['make-noisy-bright-place-easier', 'sensory-overload-what-can-i-change', 'clothing-touch-sensory-discomfort', 'temperature-smell-taste-sensory-environment', 'travel-sensory-overload-preparation']), ('Communication', ['aac-and-nonspeaking-communication', 'phone-calls-are-difficult', 'processing-time-in-conversations-meetings', 'written-vs-spoken-communication-preference', 'ask-service-email-text-instead-phone', 'mixed-neurotype-communication-misunderstandings']), ('Work', ['workplace-support-great-britain', 'reasonable-adjustments-at-work-great-britain', 'disabled-person-looking-for-work-uk', 'disclosing-disability-neurodivergence-at-work', 'job-interview-adjustments-great-britain', 'staying-in-work-performance-process-adjustments', 'occupational-health-neurodivergent-what-to-expect', 'self-employed-disabled-work-support']), ('Education & study', ['disabled-student-support-england', 'disabled-student-support-scotland', 'disabled-student-support-wales', 'disabled-student-support-northern-ireland', 'organising-study-and-assignments', 'send-support-school-college-england', 'exams-assessment-adjustments-study', 'note-taking-and-lecture-access', 'school-college-transition-support-uk', 'autistic-school-attendance-support-england']), ('Assessment & diagnosis', ['adult-adhd-assessment-england', 'adult-autism-assessment-england', 'adult-adhd-assessment-scotland', 'adult-autism-assessment-scotland', 'adult-adhd-assessment-wales', 'adult-autism-assessment-wales', 'adult-adhd-assessment-northern-ireland', 'adult-autism-assessment-northern-ireland', 'child-adhd-assessment-england', 'child-autism-assessment-england', 'child-adhd-assessment-scotland', 'child-autism-assessment-scotland', 'child-adhd-assessment-wales', 'child-autism-assessment-wales', 'child-adhd-assessment-northern-ireland', 'child-autism-assessment-northern-ireland', 'private-autism-adhd-assessment-uk', 'waiting-for-autism-adhd-assessment-uk', 'assessment-refused-or-disagree-uk', 'after-autism-adhd-assessment-uk', 'assessment-communication-sensory-adjustments-uk', 'co-occurring-autism-adhd-assessment-uk', 'other-neurodevelopmental-assessments-uk', 'adult-autism-assessment-republic-ireland', 'child-autism-assessment-republic-ireland', 'adult-adhd-assessment-republic-ireland', 'assessment-of-need-vs-diagnosis-republic-ireland', 'autism-assessment-australia', 'adhd-assessment-australia', 'autism-assessment-canada', 'child-autism-assessment-ontario']), ('Health & wellbeing', ['autism-anxiety-tools', 'masking-exhaustion-and-autistic-burnout', 'sleep-and-winding-down-routines', 'healthcare-communication-adjustments-england', 'healthcare-communication-adjustments-scotland', 'healthcare-communication-adjustments-wales', 'healthcare-communication-adjustments-northern-ireland']), ('Relationships & family', ['autistic-parent-support-uk', 'communication-needs-in-relationships', 'neurodivergent-parent-overwhelmed-by-admin', 'friendship-misunderstandings-neurodivergent', 'partner-communication-processing-sensory-needs', 'boundaries-neurodivergent-relationships', 'conflict-repair-processing-time-relationships', 'intimacy-consent-sensory-communication', 'parenting-neurodivergent-child-uk', 'disabled-neurodivergent-parent-service-access-uk', 'family-events-sensory-social-load', 'relationship-safety-domestic-abuse-help', 'should-i-leave-or-stay-relationship-boundary']), ('Money & administration', ['disability-benefits-where-start-uk', 'budgeting-when-numbers-paperwork-hard', 'debt-missed-payments-where-start', 'benefit-decision-disagree-which-process-uk', 'forms-official-paperwork-overwhelming', 'letters-bills-correspondence-pile-up', 'deadlines-renewals-appeals-remembering', 'get-help-with-money-admin-without-financial-advice']), ('Food & eating', ['sensory-food-texture-smell-eating', 'restricted-food-range-when-seek-help', 'arfid-information-without-self-diagnosis', 'cooking-meal-preparation-executive-function', 'arfid-help-scotland', 'arfid-help-wales', 'swallowing-difficulty-food-safety', 'child-restricted-eating-where-start']), ('Sleep', ['sleep-environment-sensory-load', 'shift-work-sleep-routine', 'persistent-insomnia-when-seek-help', 'sleep-medication-melatonin-boundary', 'insomnia-help-scotland', 'insomnia-help-wales', 'insomnia-help-northern-ireland', 'child-sleep-where-start-uk']), ('Mental wellbeing', ['urgent-mental-health-help-uk', 'low-mood-depression-where-start', 'trauma-distress-ptsd-assessment-boundary', 'talking-therapy-access-and-adjustments', 'mental-health-appointments-communication-sensory-adjustments', 'person-centred-suicide-safety-policy-england']), ('Healthcare access', ['hospital-appointment-reasonable-adjustments', 'dental-appointment-sensory-anxiety-adjustments', 'medication-information-without-changing-dose', 'learning-disability-register-and-annual-health-check-england']), ('Mobility & travel', ['adhd-driving-dvla-great-britain', 'disabled-travel-support-scotland', 'disabled-travel-support-wales', 'disabled-travel-support-northern-ireland', 'public-transport-assistance-disabled-uk', 'coordination-mobility-travel-planning', 'bus-coach-assistance-great-britain', 'rail-passenger-assistance-great-britain', 'translink-assistance-northern-ireland', 'travel-disruption-accessibility-planning']), ('Technology & accessibility', ['operating-system-accessibility-settings', 'speech-to-text-and-voice-control', 'reduce-digital-distraction-and-motion']), ('Organisations & peer community', ['find-local-neurodivergent-peer-group', 'online-peer-community-safety-fit', 'parent-carer-peer-support-uk', 'find-neurodivergent-led-organisation', 'how-peer-led-is-an-organisation', 'no-local-peer-group-rural-or-travel-barriers', 'peer-support-online-vs-in-person', 'check-peer-group-accessibility-before-joining', 'check-community-moderation-before-joining', 'check-community-privacy-before-joining', 'cross-neurodivergent-support-not-diagnosis-specific', 'peer-support-while-awaiting-assessment', 'leave-change-peer-group-poor-fit', 'peer-group-no-published-rules', 'peer-support-outside-england', 'tourette-peer-support-online-or-local']), ('Books & media', ['lived-experience-books-not-clinical-evidence', 'children-young-people-neurodivergent-fiction', 'choosing-neurodiversity-book-media', 'neurodiversity-intro-media-where-start', 'neurodivergent-book-accessible-formats', 'neurodivergent-authorship-beyond-autism-adhd', 'neurodiversity-podcast-documentary-how-check']), ('Information & support', ['autism-information-and-support', 'dyslexia-information-and-support-uk', 'tourette-information-and-support-uk', 'learning-disability-information-and-support-uk', 'dld-information-and-support', 'adult-dyspraxia-information-uk', 'dyscalculia-information-and-support-uk']), ('Games & downtime', ['low-time-pressure-games', 'low-reaction-demand-games', 'easy-to-interrupt-games', 'configurable-game-pressure', 'simple-control-games', 'low-consequence-games', 'solo-low-social-pressure-games', 'building-sorting-collecting-games', 'gaming-community-social-load', 'low-sensory-demand-games', 'checking-game-accessibility-before-buying', 'adult-autistic-gaming-communities'])]
_compat09__QUESTION_GROUPS = QUESTION_GROUPS
_compat08__QUESTION_GROUPS = QUESTION_GROUPS
_compat09__V09_ROUTE_COUNT = 388
...
def build(output_dir=_compat06__DEFAULT_OUTPUT_DIR):
    ...
    text = _evidence_v1_re.sub(
        ...
        '<section aria-labelledby="evidence-search-heading"><h2 id="evidence-search-heading">Find a source locally</h2><p>This catalogue sends no search query anywhere and loads no script. Use your browser’s built-in <strong>Find in page</strong> command (usually Ctrl+F or Command+F), or browse the governed source catalogue below.</p></section>',
        text,
        count=1,
